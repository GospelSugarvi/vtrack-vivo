-- ==========================================================
-- FIX: get_store_recommendations dan update_stock_rule
-- ==========================================================

-- 1. Drop dan recreate get_store_recommendations (kalau ada)
DROP FUNCTION IF EXISTS get_store_recommendations(uuid);

-- 2. Drop dan recreate update_stock_rule (pakai TEXT, bukan UUID)
