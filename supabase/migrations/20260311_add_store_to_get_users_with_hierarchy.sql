-- Migration: add store_name to get_users_with_hierarchy
...
BEGIN
    IF p_role = 'promotor' THEN
        ...
        LEFT JOIN public.assignments_promotor_store aps
          ON aps.promotor_id = u.id AND aps.active = true
        ...
        ORDER BY sator.full_name NULLS LAST, st.store_name NULLS LAST, u.full_name;
