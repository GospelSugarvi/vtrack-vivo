    ...
    select jsonb_build_object(
      ...
      'daily', coalesce(
        (
          ...
          from public.vast_agg_daily_spv d
          where d.spv_id = v_actor_id
      ...
      'weekly', coalesce(
        (
          ...
          from public.vast_agg_weekly_spv w
          where w.spv_id = v_actor_id
      ...
      'monthly', coalesce(
        (
          ...
          from public.vast_agg_monthly_spv m
          where m.spv_id = v_actor_id
