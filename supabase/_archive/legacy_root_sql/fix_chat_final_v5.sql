-- =====================================================
-- FIX CHAT SYSTEM V5 (ENUM SAFE)
-- Date: 30 January 2026
-- Description: Fixes Error 22P02 "invalid input value for enum user_role: 'user'".
--              Casts ENUM columns to TEXT/VARCHAR before COALESCE operations.
-- =====================================================
...
-- =====================================================
-- 2. GET USER CHAT ROOMS (Enum Safe)
-- =====================================================
...
BEGIN
    ...
    SELECT 
        cr.id as room_id,
        cr.id, 
        -- Cast BEFORE Coalescing/returning
...
BEGIN
    ...
    SELECT 
        ...
        -- CRITICAL FIX: Cast ENUM to TEXT explicitly before COALESCE
        -- This prevents Postgres from trying to cast 'user' to user_role enum
        COALESCE(u.role::TEXT, 'user')::VARCHAR(50) as sender_role,
